...
generate_preview () {
    convert -density 250 -background white -alpha remove golang-ref-sheet.pdf[0] -crop 600x400+$1+$2 \( +clone -background black -shadow 80x3+4+4 \) +swap -background white -layers merge +repage github/$3
}
